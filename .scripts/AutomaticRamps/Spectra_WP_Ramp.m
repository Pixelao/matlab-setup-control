AnglesRamp=0:180:360;
% Imin=1.1e-7;
% Imax=1.11e-7;
DestinationPath='C:\Users\Usuario\Desktop\pruebas\WP=';%select folder to save
...
%     end
    ...
    save([DestinationPath num2str(AnglesRamp(n)) 'º.mat'],'MeasurementData')
    pause(5)
end
